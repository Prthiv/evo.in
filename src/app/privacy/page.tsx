      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            or make a purchase from evo.in (the "Site").
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            For example, we use Razorpay to power our payment processing--you can read more about how Razorpay uses your 
            Personal Information here: https://razorpay.com/privacy/.
          </p>
          <p className="mb-4">
            We also use Google Analytics to help us understand how our customers use the Site--you can read more about 
            how Google uses your Personal Information here: https://www.google.com/intl/en/policies/privacy/. 
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>TWITTER - https://help.twitter.com/en/safety-and-security/privacy-controls-for-tailored-ads</li>
          </ul>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            contracts we might have with you (for example if you make an order through the Site), or otherwise to pursue 
            our legitimate business interests listed above. Additionally, please note that your information will be 
