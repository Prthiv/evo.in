...
import { Package, Truck, Home, ArrowLeft } from "lucide-react";
import Link from "next/link";
import { OrderStatusTimeline } from "@/components/order-status-timeline";
import { UpdateOrderStatus } from "@/components/admin/update-order-status";

export default function StudioOrderDetailsPage({ params }: { params: { id: string }}) {
    ...
    return (
        <div className="space-y-6">
             <Button asChild variant="outline">
                <Link href="/studio/orders"><ArrowLeft className="mr-2"/> Back to All Orders</Link>
            </Button>
             <Card>
                <CardHeader>
