    ...
    <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p className="mb-4">
            This website is operated by Evo.in. Throughout the site, the terms "we", "us" and "our" refer to Evo.in. 
            Evo.in offers this website, including all information, tools and services available from this site to you, 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            of connecting networks or devices. Credit card information is always encrypted during transfer over networks.
          </p>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            time, but we have no obligation to update any information on our site. You agree that it is your responsibility 
            to monitor changes to our site.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            For more details, please review our Return Policy: <a href="/shipping-returns" className="text-primary hover:underline">Shipping & Returns</a>
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Any use by you of the optional tools offered through the site is entirely at your own risk and discretion and 
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
          <p className="mb-4">
            ...
            publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We are and shall 
            be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) 
          ...
          <p className="mb-4">
            ...
            or other personal or proprietary right; that your comments will not contain libelous or otherwise unlawful, abusive 
            or obscene material; and that your comments will not be used to solicit or promote business or custom or present 
            commercial activities or unlawful activity.
          </p>
          <p className="mb-4">
            You hereby grant us a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit 
            any of your comments in any and all forms, media, or technology.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            for your use, without any representation, warranties or conditions of any kind, either express or implied, including all 
            implied warranties or conditions of merchantability, merchantable quality, fitness for a particular purpose, durability, 
            title, and non-infringement.
          </p>
          <p className="mb-4">
            In no case shall Evo.in, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service 
            ...
            related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in 
            any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            You agree to indemnify, defend and hold harmless Evo.in and our parent, subsidiaries, affiliates, partners, officers, 
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">SECTION 19 - CHANGES TO TERMS</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            ...
            <a href="mailto:support@evo.in" className="text-primary hover:underline">
              support@evo.in
            </a>
          </p>
        </section>
